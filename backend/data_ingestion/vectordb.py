...
class VectorDB:
    ...
    def chormaDB_server(self, chunks, save_to_disk=False):
        ...
        emb_fn = CustomOpenAIEmbeddings(openai_api_key=settings.DTC_OPENAI_API_KEY)  
        ...
        collection = client.get_collection(name=settings.DTC_CHROMA_COLLECTION_NAME, embedding_function=emb_fn)
        for doc in chunks:
            collection.add(
